    ...
    return (
        <div className="relative">
            ...
            <div className="absolute top-[3.5rem]">
                ...
                <span className="absolute top-[13rem] left-[14rem] h-1 w-[28rem] bg-red-500"></span>
                <span className="absolute top-[14rem] left-[13rem] h-1 w-[30rem] bg-red-500"></span>
                <div className="absolute z-20 top-[15rem] left-[12rem] w-[32rem] border-4 border-white border-t-red-500">
                    <p className="text-[4rem] text-center ">
                        Choose your style with the best clothes
                    </p>
                </div>
                <div className="absolute z-20 top-[29rem] left-[22rem] w-[12rem]">
                    <p className=" text-[4.5rem] font-bold text-center border-8 border-black uppercase cursor-pointer">
                        Here
                    </p>
