...
const Search = ():JSX.Element => {
    return (
        <div className='group flex items-center px-3 py-1 border-slate-600  transition border-2 duration-500 ease-in-out hover:border-2 hover:border-cyan-500'>
            <form>
                <input type='text' placeholder='T-Shirts, Pants...' className='py-1 m-1 w-28 bg-transparent focus:outline-none placeholder:text-black group-hover:placeholder:text-cyan-500'/>
            </form>
